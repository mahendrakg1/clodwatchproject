...
//if there are errors in the secrete and access key
      ...
      $response = $cw->get_metric_statistics($Namespace, "NetworkIn", $start_time, $end_time, $period, $Statistics, "Bytes", $opts);
...
// Sort by key while maintaining association in order to have an oldest->newest sorted dataset
      $response = $cw->get_metric_statistics($Namespace, "NetworkIn", "-7 day", "now", 86400, $Statistics, "Bytes", $opts);
     ...
     foreach ($d1 as $p) {
       ...
       ?>
                ...
                function drawChart() {
                    ...
                    data1.addColumn('number', 'Network In');
                    for (var i = 0; i < 7; i++)
                    {
                        data1.addRows([
                    ...
                    // Set chart options
                    var options = {'title': 'NETWORK IN PER DAY',
                        'width': 400,
                        'height': 300,
                        'vAxis': {title: "NetworkIn in Bytes"},
                        'hAxis': {title: "time in h:m"}
                    };
                    var options2 = {'title': 'NETWORK IN PER WEEK',
                        'width': 500,
                        'height': 300,
                        'vAxis': {title: "NetworkIn in Bytes"},
            ...
            <div class="row">
                <div class="span2">
                    <ul class="nav nav-list">
                        ...
                        <li class="active"><a href="networkin.php">NetworkIn</a></li>
