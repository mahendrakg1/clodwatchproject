     ...
     foreach ($d1 as $p) {
       ...
       ?>
                ...
                function drawChart() {
                    ...
                    data.addColumn('number', 'disk read');
                    for (var i = 0; i < 23; i++)
                    {
                        data.addRows([
                    ...
                    data1.addColumn('number', 'disk read');
                    for (var i = 0; i < 7; i++)
                    {
                        data1.addRows([
                    ...
                    // Set chart options
                    var options = {'title': 'DISK READ PER DAY',
                        'width': 400,
                        'height': 300,
                        'vAxis': {title: "diskread in bytes"},
                        'hAxis': {title: "time in h:m"}
                    };
                    var options2 = {'title': 'DISK READ PER MONTH',
                        'width': 500,
                        'height': 300,
                        'vAxis': {title: "diskread in bytes"},
            ...
            <div class="row">
                <div class="span2">
                    <ul class="nav nav-list">
                        ...
                        <li class="active"><a href="diskread.php">DiskReadBytes</a></li>
