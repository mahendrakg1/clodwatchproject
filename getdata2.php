...
try {
    ...
    if ($region == "ap-southeast-1")
        $cw->set_region(AmazonCloudWatch::REGION_APAC_SE1);
    elseif ($region == "ap-northeast-1")
        $cw->set_region(AmazonCloudWatch::REGION_APAC_NE1);
    elseif ($region == "ap-southeast-2")
        $cw->set_region(AmazonCloudWatch::REGION_APAC_SE2);
    elseif ($region == "us-west-2")
        $cw->set_region(AmazonCloudWatch::REGION_US_W2);
    elseif ($region == "us-west-1")
        $cw->set_region(AmazonCloudWatch::REGION_US_W1);
    elseif ($region == "sa-east-1")
        $cw->set_region(AmazonCloudWatch::REGION_SA_E1);
    elseif ($region == "eu-west-1")
        $cw->set_region(AmazonCloudWatch::REGION_EU_W1);
    elseif ($region == "us-east-1")
...
$member = array(Name => "InstanceId", Value => "$instance");
